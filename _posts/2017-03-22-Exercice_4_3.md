...
<p align="justify">Dans le cadre de cet exercice, il vous est demandé de télécharger les cours journalier sur les trois dernières années des actions faisant actuellement (au 17 mars 2017 dans cet exemple) partie de l'indice CAC 40  en utilisant le wrapper API **BatchGetSymbols**.
...
Il a été créé le 31 décembre 1987. Date à laquelle, il prend la valeur 1000. Son code ISIN est FR0003500008 et son ticker ^FCHI. L'évolution de sa valeur ne prend pas en compte le réinvestissement des dividendes.</p>
